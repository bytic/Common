...
namespace ByTIC\Common\Tests\Data\Unit\Payments\Gateways\Providers\Euplatesc;

use Symfony\Component\HttpFoundation\Request as HttpRequest;

/**
 * Class EuplatescData
 * @package ByTIC\Common\Tests\Data\Unit\Payments\Gateways\Providers\Euplatesc
 */
class EuplatescData
{
    /**
    ...
    {
        return trim(file_get_contents(\Codeception\Configuration::dataDir().'\PaymentGateways\EuplatescOptions.serialized'));
    }
