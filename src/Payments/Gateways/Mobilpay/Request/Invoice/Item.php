...
namespace ByTIC\Common\Payments\Gateways\Mobilpay\Request\Invoice;
...
class Item
{
    ...
    protected function loadFromXml(DOMNode $elem)
    {
        ...
        if ($elems->length != 1) {
            throw new Exception('Mobilpay_Payment_Invoice_Item::loadFromXml failed! Invalid code element.',
        ...
        if ($elems->length != 1) {
            throw new Exception('Mobilpay_Payment_Invoice_Item::loadFromXml failed! Invalid name element.',
